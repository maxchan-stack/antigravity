# 物理科段考成績查詢系統 - 完整部署指南 (V6.2)

**版本**：V6.2 MAXCHAN Security Edition  
**最後更新**：2026年1月17日  
**適用人數**：最多 240 人（可擴展）  
...
| `學號` | 學生學號（**唯一識別碼**） | 10101 |
| `姓名` | 學生姓名 | 王小明 |
| `座號` | 學生座號（**V6.2 新增，用於安全驗證**） | 1 |
| `查詢碼` | 系統自動生成，**留空即可** | (空白) |
| `Email` | 用於寄送查詢碼（選填） | student@school.edu.tw |
...
| V5.7 | 2026-01-16 | Starlux + Apple UI、單頁趨勢比對 |
